...
$orderInfo = "Thanh toán qua MoMo ATM nội địa";
$amount = "10000";
$orderId = time() ."";
$returnUrl = "http://www.momotesting.com:8000/atm/result_atm.php";
$notifyurl = "http://www.momotesting.com:8000/atm/ipn_momo.php";
...
if (!empty($_POST)) {
    ...
    $data =  array('partnerCode' => $partnerCode,
                ...
                'requestType' => $requestType,
                'signature' => $signature);
    $result = execPostRequest($endpoint, json_encode($data)); // error
